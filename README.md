...
[Checkstyle plugin](https://wiki.jenkins-ci.org/display/JENKINS/Checkstyle+Plugin) or 
[Bamboo](https://www.atlassian.com/software/bamboo) with the 
[View Checkstyle addon](https://marketplace.atlassian.com/plugins/eu.markusschulte.atlassian.bamboo.plugin.report-checkstyle/).
